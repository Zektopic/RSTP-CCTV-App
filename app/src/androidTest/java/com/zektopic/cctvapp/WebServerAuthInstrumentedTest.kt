...
class WebServerAuthInstrumentedTest {
    ...
    fun startServer() {
        ...
        server = WebServer(
            ...
            getCodecSupportJson = { CodecCapabilities.toJson(emptyMap()) },
            getAdaptiveQualityEnabled = { true },
            getThermalStatus = { AdaptiveQuality.THERMAL_NONE },
            getQualityScalePercent = { 100 },
            getQualityTrigger = { AdaptiveQuality.Trigger.NONE.name },
            getActiveSnapshotIntervalMs = { CaptureProfile.DEFAULT_ACTIVE_INTERVAL_MS },
            getIdleSnapshotIntervalMs = { CaptureProfile.DEFAULT_IDLE_INTERVAL_MS },
            getAnalysisWidth = { CaptureProfile.DEFAULT_ANALYSIS_WIDTH },
            getSnapshotJpegQuality = { CaptureProfile.DEFAULT_JPEG_QUALITY },
            getBitrateKbps = { AppPreferences.BITRATE_AUTO },
            getActiveBitrateKbps = { 2000 },
            getVideoFps = { EncoderProfile.DEFAULT_FPS },
            getKeyframeIntervalSeconds = { EncoderProfile.DEFAULT_KEYFRAME_INTERVAL_SECONDS },
